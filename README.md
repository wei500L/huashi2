...
- `REDIS_PASSWORD`
- AI 供应商相关变量：`AI_OPENAI_API_KEY`、`AI_OPENAI_BASE_URL`、`AI_CHAT_MODEL`、`AI_EMBEDDING_BASE_URL`、`AI_EMBEDDING_MODEL`、`AI_MULTIMODAL_EMBEDDING_MODEL`、`AI_RERANK_PROTOCOL`、`AI_RERANK_BASE_URL`、`AI_RERANK_MODEL`、`AI_MULTIMODAL_RERANK_MODEL`
