...
public class InternalAiConfigController {
    ...
    @PostMapping("/apply")
    public ApiResponse<AiOpsConfigApplyResponse> apply(@RequestBody AiOpsConfigPayload request) {
        AiOpsConfigEffectiveResponse response = runtimeConfigService.apply(request, "ADMIN_APPLY", null);
