...
public record AiOpsRagRetrievalConfig(
        ...
        @Max(value = 128, message = "recallTopK must be less than or equal to 128")
        Integer recallTopK,
        ...
        @Max(value = 128, message = "rerankTopN must be less than or equal to 128")
        Integer rerankTopN,
        ...
        @Max(value = 32, message = "finalTopK must be less than or equal to 32")
        Integer finalTopK,
        @NotNull(message = "hnswEfSearch is required")
        @Positive(message = "hnswEfSearch must be greater than 0")
        @Max(value = 1000, message = "hnswEfSearch must be less than or equal to 1000")
