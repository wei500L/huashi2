...
CREATE TABLE `assessment_attempt` (
  ...
  `active_participant_id` bigint GENERATED ALWAYS AS ((case when (`deleted` = false) then `participant_id` else NULL end)) STORED,
  PRIMARY KEY (`id`),
...
CREATE TABLE `assessment_question_bank` (
  ...
  CONSTRAINT `fk_assessment_question_bank_owner` FOREIGN KEY (`owner_user_id`) REFERENCES `users` (`id`)
);
CREATE TABLE `assessment_question_version` (
  ...
  CONSTRAINT `fk_assessment_question_version_bank` FOREIGN KEY (`question_bank_id`) REFERENCES `assessment_question_bank` (`id`)
);
CREATE TABLE `assessment_questionnaire` (
  ...
  CONSTRAINT `fk_assessment_questionnaire_owner` FOREIGN KEY (`owner_user_id`) REFERENCES `users` (`id`)
);
CREATE TABLE `assessment_questionnaire_version` (
  ...
  CONSTRAINT `fk_assessment_questionnaire_version_questionnaire` FOREIGN KEY (`questionnaire_id`) REFERENCES `assessment_questionnaire` (`id`),
  CONSTRAINT `fk_assessment_questionnaire_version_paper` FOREIGN KEY (`paper_id`) REFERENCES `assessment_paper` (`id`)
);
CREATE TABLE `assessment_questionnaire_section` (
  ...
  CONSTRAINT `fk_assessment_questionnaire_section_version` FOREIGN KEY (`questionnaire_version_id`) REFERENCES `assessment_questionnaire_version` (`id`)
);
CREATE TABLE `assessment_questionnaire_item` (
  ...
  CONSTRAINT `fk_assessment_questionnaire_item_version` FOREIGN KEY (`questionnaire_version_id`) REFERENCES `assessment_questionnaire_version` (`id`),
  CONSTRAINT `fk_assessment_questionnaire_item_section` FOREIGN KEY (`section_id`) REFERENCES `assessment_questionnaire_section` (`id`),
  CONSTRAINT `fk_assessment_questionnaire_item_question` FOREIGN KEY (`assessment_question_id`) REFERENCES `assessment_question` (`id`),
  CONSTRAINT `fk_assessment_questionnaire_item_qversion` FOREIGN KEY (`question_version_id`) REFERENCES `assessment_question_version` (`id`)
);
CREATE TABLE `assessment_public_release` (
  ...
  CONSTRAINT `fk_assessment_public_release_publish` FOREIGN KEY (`publish_id`) REFERENCES `assessment_publish` (`id`)
);
CREATE TABLE `assessment_participation_code` (
  ...
  CONSTRAINT `fk_assessment_participation_code_release` FOREIGN KEY (`public_release_id`) REFERENCES `assessment_public_release` (`id`)
);
CREATE TABLE `assessment_participant` (
  ...
  CONSTRAINT `fk_assessment_participant_publish` FOREIGN KEY (`publish_id`) REFERENCES `assessment_publish` (`id`),
  CONSTRAINT `fk_assessment_participant_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `fk_assessment_participant_code` FOREIGN KEY (`participation_code_id`) REFERENCES `assessment_participation_code` (`id`),
  CONSTRAINT `fk_assessment_participant_attempt` FOREIGN KEY (`attempt_id`) REFERENCES `assessment_attempt` (`id`)
);
CREATE TABLE `assessment_participant_access` (
  ...
  CONSTRAINT `fk_assessment_participant_access_release` FOREIGN KEY (`public_release_id`) REFERENCES `assessment_public_release` (`id`),
  CONSTRAINT `fk_assessment_participant_access_participant` FOREIGN KEY (`participant_id`) REFERENCES `assessment_participant` (`id`),
  CONSTRAINT `fk_assessment_participant_access_code` FOREIGN KEY (`participation_code_id`) REFERENCES `assessment_participation_code` (`id`)
);
CREATE TABLE `assessment_participant_session` (
  ...
  CONSTRAINT `fk_assessment_participant_session_participant` FOREIGN KEY (`participant_id`) REFERENCES `assessment_participant` (`id`)
);
CREATE TABLE `assessment_question_bank_import` (
  ...
  CONSTRAINT `fk_assessment_question_bank_import_bank` FOREIGN KEY (`question_bank_id`) REFERENCES `assessment_question_bank` (`id`),
  CONSTRAINT `fk_assessment_question_bank_import_confirmed` FOREIGN KEY (`confirmed_by`) REFERENCES `users` (`id`),
  CONSTRAINT `fk_assessment_question_bank_import_committed` FOREIGN KEY (`committed_by`) REFERENCES `users` (`id`)
);
CREATE TABLE `assessment_content_review_issue` (
  ...
  CONSTRAINT `fk_assessment_content_review_issue_import` FOREIGN KEY (`import_id`) REFERENCES `assessment_question_bank_import` (`id`),
  CONSTRAINT `fk_assessment_content_review_issue_question` FOREIGN KEY (`question_version_id`) REFERENCES `assessment_question_version` (`id`),
  CONSTRAINT `fk_assessment_content_review_issue_resolver` FOREIGN KEY (`resolved_by`) REFERENCES `users` (`id`)
);
CREATE TABLE `assessment_timing_event` (
  ...
  CONSTRAINT `fk_assessment_timing_event_attempt` FOREIGN KEY (`attempt_id`) REFERENCES `assessment_attempt` (`id`),
  CONSTRAINT `fk_assessment_timing_event_question` FOREIGN KEY (`question_id`) REFERENCES `assessment_question` (`id`),
...
CREATE TABLE `assessment_metric_snapshot` (
  ...
  CONSTRAINT `fk_assessment_metric_snapshot_attempt` FOREIGN KEY (`attempt_id`) REFERENCES `assessment_attempt` (`id`)
);
CREATE TABLE `assessment_ai_analysis` (
  ...
  CONSTRAINT `fk_assessment_ai_analysis_attempt` FOREIGN KEY (`attempt_id`) REFERENCES `assessment_attempt` (`id`),
  CONSTRAINT `fk_assessment_ai_analysis_metric` FOREIGN KEY (`metric_snapshot_id`) REFERENCES `assessment_metric_snapshot` (`id`),
  CONSTRAINT `fk_assessment_ai_analysis_generation` FOREIGN KEY (`generation_record_id`) REFERENCES `ai_generation_record` (`id`)
);
CREATE TABLE `assessment_submission_file` (
  ...
  CONSTRAINT `fk_assessment_submission_file_attempt` FOREIGN KEY (`attempt_id`) REFERENCES `assessment_attempt` (`id`),
  CONSTRAINT `fk_assessment_submission_file_answer` FOREIGN KEY (`answer_id`) REFERENCES `assessment_attempt_answer` (`id`),
  CONSTRAINT `fk_assessment_submission_file_question` FOREIGN KEY (`question_id`) REFERENCES `assessment_question` (`id`),
  CONSTRAINT `fk_assessment_submission_file_participant` FOREIGN KEY (`participant_id`) REFERENCES `assessment_participant` (`id`),
  CONSTRAINT `fk_assessment_submission_file_student` FOREIGN KEY (`student_user_id`) REFERENCES `users` (`id`)
);
CREATE TABLE `research_aggregate_snapshot` (
  ...
  CONSTRAINT `fk_research_aggregate_snapshot_publish` FOREIGN KEY (`publish_id`) REFERENCES `assessment_publish` (`id`),
  CONSTRAINT `fk_research_aggregate_snapshot_paper` FOREIGN KEY (`paper_id`) REFERENCES `assessment_paper` (`id`)
);
CREATE TABLE `research_ai_report` (
  ...
  CONSTRAINT `fk_research_ai_report_publish` FOREIGN KEY (`publish_id`) REFERENCES `assessment_publish` (`id`),
  CONSTRAINT `fk_research_ai_report_snapshot` FOREIGN KEY (`aggregate_snapshot_id`) REFERENCES `research_aggregate_snapshot` (`id`),
  CONSTRAINT `fk_research_ai_report_generation` FOREIGN KEY (`generation_record_id`) REFERENCES `ai_generation_record` (`id`)
);
CREATE TABLE `research_export_job` (
  ...
  CONSTRAINT `fk_research_export_job_publish` FOREIGN KEY (`publish_id`) REFERENCES `assessment_publish` (`id`)
);
...
CREATE TABLE `lexical_pair` (
  ...
  `active_source_code` varchar(64) GENERATED ALWAYS AS ((case when (`deleted` = false) then `source_code` else NULL end)) STORED,
  `active_content_version` varchar(64) GENERATED ALWAYS AS ((case when (`deleted` = false) then `content_version` else NULL end)) STORED,
  `active_word_id` varchar(128) GENERATED ALWAYS AS ((case when (`deleted` = false) then `word_id` else NULL end)) STORED,
  PRIMARY KEY (`id`),
